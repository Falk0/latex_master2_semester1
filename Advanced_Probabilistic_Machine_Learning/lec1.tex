...
% disjoint set, add probability of getting 1 and 2 with a dice
...
% Given that we have seen event A what is the probability of see B
...
\begin{example}{Example: medical test paradox}
    ...
    \vspace{2em}
    \includegraphics{/Users/linusfalk/Documents/latex/latex_master2_semester1/figures/new-figure-1693225279114.pdf}
...
% The prior knowledge has a huge effect on the result, the medical example. Often we the testperson has some kind of symptom making and is the 0.001 is higher
...
\begin{figure}[ht!]
\centering
\includegraphics{/Users/linusfalk/Documents/latex/latex_master2_semester1/figures/new-figure-1693205116382.pdf}
...
% latent, parameters, that we want to learn for example
...
\begin{example}{Example: Coin flip (>Frequentist viewpoint)}
    ...
    \includegraphics{/Users/linusfalk/Documents/latex/latex_master2_semester1/figures/new-figure-1693228570232.pdf}
...
% After lecture 4 get started on mini project 
% Report October 6



% Go over Marginalization and conditioning again, joint density. 
